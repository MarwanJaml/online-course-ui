...
import { PalnsAndPricingComponent } from './components/palns-and-pricing/palns-and-pricing.component';
...
export const routes: Routes = [
...

  {
    ...
    loadComponent: () =>
      import('./components/palns-and-pricing/palns-and-pricing.component').then(
        (m) => m.PalnsAndPricingComponent
      ),
  },
